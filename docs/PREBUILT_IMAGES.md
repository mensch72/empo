...
- Python 3.11 with all dependencies from `setup/requirements/base.txt` and `setup/requirements/dev.txt`
...
- `setup/requirements/base.txt` or `setup/requirements/dev.txt` are modified
