...
├── setup/requirements/base.txt              # Core dependencies
├── setup/requirements/dev.txt          # Dev dependencies
...
Edit `setup/requirements/base.txt` or `setup/requirements/dev.txt`, then rebuild:
```bash
