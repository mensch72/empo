...
- ✅ `setup/requirements/base.txt`: PyTorch >=2.0.0, JAX (optional), Gymnasium, PettingZoo, Multigrid
...
├── setup/requirements/base.txt        # Core deps
├── setup/requirements/dev.txt    # Dev deps
...
3. **setup/requirements/base.txt** - Core dependencies (PyTorch, MARL, etc.)
