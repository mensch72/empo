...
| [`phase2_multistep_targets_and_mcts.md`](./phase2_multistep_targets_and_mcts.md) | Planning | — | Proposal for optional multi-step / whole-episode targets for the DQN-style Phase 2 path and optional MCTS-based `π_r` improvement. |
