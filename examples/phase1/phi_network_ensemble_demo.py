...
Usage:
    python examples/phase1/phi_network_ensemble_demo.py           # Full run (500 episodes)
    python examples/phase1/phi_network_ensemble_demo.py --quick   # Quick test run (50 episodes)
