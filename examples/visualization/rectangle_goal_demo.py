...
Usage:
    python examples/visualization/rectangle_goal_demo.py           # Full run (300 episodes)
    python examples/visualization/rectangle_goal_demo.py --quick   # Quick test run (30 episodes)
