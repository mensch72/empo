...
Usage:
    python examples/diagnostics/bellman_backward_induction.py           # Full run (8 time steps)
    python examples/diagnostics/bellman_backward_induction.py --quick   # Quick test (4 time steps)
    python examples/diagnostics/bellman_backward_induction.py --profile # Enable line-by-line profiling
