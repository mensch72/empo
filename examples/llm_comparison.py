...
PYTHONPATH=src:vendor/multigrid python examples/llm_comparison.py
PYTHONPATH=src:vendor/multigrid python examples/llm_comparison.py --quick
PYTHONPATH=src:vendor/multigrid python examples/llm_comparison.py --model claude-sonnet-4-20250514
...
import sys
sys.path.insert(0, '../../empo/src')
sys.path.insert(0, '../../empo/vendor/multigrid')
