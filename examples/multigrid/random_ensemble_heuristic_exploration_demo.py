...
Usage:
    python examples/multigrid/random_ensemble_heuristic_exploration_demo.py              # Default settings
    python examples/multigrid/random_ensemble_heuristic_exploration_demo.py --steps 200  # Longer rollout
    python examples/multigrid/random_ensemble_heuristic_exploration_demo.py --walls 0.2  # More walls
    python examples/multigrid/random_ensemble_heuristic_exploration_demo.py --seed 123   # Different random map
