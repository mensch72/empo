...
Usage:
    python examples/multigrid/random_multigrid_ensemble_demo.py           # Full run (500 episodes)
    python examples/multigrid/random_multigrid_ensemble_demo.py --quick   # Quick test run (50 episodes)
