...
Usage:
    python examples/multigrid/heuristic_multigrid_ensemble_demo.py           # Full run (100 rollouts)
    python examples/multigrid/heuristic_multigrid_ensemble_demo.py --quick   # Quick test (10 rollouts)
    python examples/multigrid/heuristic_multigrid_ensemble_demo.py --beta 50  # More deterministic
...
# ============================================================================
# Goal Sampler (copied from examples/multigrid/random_multigrid_ensemble_demo.py)
# ============================================================================
