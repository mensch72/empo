...
python examples/phase2/phase2_robot_policy_demo.py --quick --config examples/phase2/configs/trajectory_n_step_direct.yaml
python examples/phase2/phase2_robot_policy_demo.py --quick --config examples/phase2/configs/trajectory_episode_direct.yaml
python examples/phase2/phase2_robot_policy_demo.py --quick --config examples/phase2/configs/mcts_one_step_search.yaml
