...
Rewritten from scratch using examples/transport/transport_two_cluster_demo.py as a template
to ensure correct video rendering.

Usage:
    python examples/transport/transport_stress_test_demo.py
"""
...
def run_stress_test_rollout(env, policies, max_steps=100, profile=True):
    ...
    This follows the same pattern as examples/transport/transport_two_cluster_demo.py
