...
Usage:
    python examples/transport/transport_random_demo.py           # Full run (100 steps)
    python examples/transport/transport_random_demo.py --quick   # Quick test run (20 steps)
    python examples/transport/transport_random_demo.py --render  # Enable graphical rendering
    python examples/transport/transport_random_demo.py --wrapper # Use TransportEnvWrapper with action masking
