...
def main() -> None:
    ...
    parser.add_argument("--gamma_h", type=float, default=0.999,
                        help="Discount factor for human values (default: 0.999)")
    parser.add_argument("--gamma_r", type=float, default=0.999,
                        help="Discount factor for robot values (default: 0.999)")
    parser.add_argument("--zeta", type=float, default=1.1,
                        help="Risk-aversion parameter (default: 1.1)")
    ...
    parser.add_argument("--steps", type=int, default=20,
                        help="Max environment steps per episode (default: 20)")
