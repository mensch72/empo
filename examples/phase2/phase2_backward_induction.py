...
Usage:
    python examples/phase2/phase2_backward_induction.py           # Default trivial world, 5 max steps
    python examples/phase2/phase2_backward_induction.py --steps 3 # Shorter horizon
    python examples/phase2/phase2_backward_induction.py --world basic/two_agents  # Use custom world
