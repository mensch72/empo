...
Usage:
    # Basic usage
    python examples/phase2/phase2_robot_policy_demo.py           # Full run (trivial env)
    python examples/phase2/phase2_robot_policy_demo.py --quick   # Quick test (100 episodes)
    python examples/phase2/phase2_robot_policy_demo.py --small   # Use small 6x6 environment
    python examples/phase2/phase2_robot_policy_demo.py --ensemble # Use random ensemble environment
    python examples/phase2/phase2_robot_policy_demo.py --world basic/two_agents  # Use custom world from YAML
    python examples/phase2/phase2_robot_policy_demo.py --async   # Use async actor-learner training
    ...
    python examples/phase2/phase2_robot_policy_demo.py --save_networks model.pt  # Custom path for networks
    python examples/phase2/phase2_robot_policy_demo.py --restore_networks model.pt  # Resume training
