...
Usage:
    python examples/phase2/lookup_table_phase2_demo.py                 # Full training
    python examples/phase2/lookup_table_phase2_demo.py --steps 100     # Quick test
    python examples/phase2/lookup_table_phase2_demo.py --inspect       # Show learned values
"""
